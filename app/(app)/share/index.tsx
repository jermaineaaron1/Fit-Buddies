    ...
    <AnimatedScreen>
      <CompactCard accent="gold">
        <View style={styles.introHead}>
          ...
          <Text style={styles.introTitle}>Fuel</Text>
        </View>
        <Text style={styles.introCopy}>
          What the crew is cooking, buying and taking. To record your own meal, use Quick Log —
          you do not need to come in here for that.
        </Text>
        <View style={styles.introActions}>
          <CompactButton label="Log a meal" icon="add" tone="gold" onPress={openQuickLog} />
